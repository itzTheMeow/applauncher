...
var apps = [];
electron_1.ipcRenderer.on("apps", function (e, a) {
    apps = a;
});
...
electron_1.contextBridge.exposeInMainWorld("hide", function () {
    electron_1.ipcRenderer.sendSync("hide");
});
